...
Um mit dem Klaros-Testmanagement zu beginnen, lesen Sie bitte unser Tutorial und das Benutzerhandbuch. Beide sind auch in der Anwendung selbst nach erfolgreicher Anmeldung verfügbar. 
