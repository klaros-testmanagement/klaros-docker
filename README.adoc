...
image:https://img.shields.io/badge/Version-5.7.6-green.svg[link="https://github.com/klaros-testmanagement/klaros-docker/releases"]
...
|KLAROS_VERSION    |${KLAROS_VERSION:-5.7.6} |Klaros release version, which is used during installation. A list of available releases can be found on the official https://www.klaros-testmanagement.com/en_US/download[Klaros Test Management] website or on https://github.com/klaros-testmanagement/klaros-docker/releases[GitHub]
|=======================
...
* https://github.com/akaer[André Raabe] for providing the Apache Derby and Microsoft SQL Server Version
