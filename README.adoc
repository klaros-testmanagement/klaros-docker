...
IMPORTANT: If the update is only for testing purposes, do not use the original branch(klaros).
...
Our documentation includes the installation of Klaros Test Management under Docker for the Apache Derby, MySQL, and PostgreSQL databases.
