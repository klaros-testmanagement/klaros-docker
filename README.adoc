...
|ENV JAVA_OPTS -Duser.timezone=Europe/Berlin  |-Duser.timezone=  | With JAVA_OPTS additional settings can be transferred to the TomCat server. In this example the time zone is set to Europe/Berlin.
