...
|DATABASE_CONTAINER_NAME=klaros_db |DATABASE_CONTAINER_NAME=klaros_db2 |Database Containername
...
If you are interested in our software, you can read our https://www.klaros-testmanagement.com/files/tutorial/html/Tutorial.index.html[tutorial] for beginners or the https://www.klaros-testmanagement.com/files/doc/html/User-Manual.index.html[user manual] for more advanced features.
...
== FAQ
If you have further questions about Klaros Test Management and the Enterprise Edition, please have a look at our https://www.klaros-testmanagement.com/en_US/faq?inheritRedirect=true[Pricing-FAQ] and https://www.klaros-testmanagement.com/en_US/support?inheritRedirect=true[Support-FAQ.]
