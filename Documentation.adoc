...
After the repository has been cloned, the tags can be listed with `git tag` and with `git checkout tags/<tag_name> -b <new_branch>` "new_branch" is created and checked out.
