...
The database systems: MySQL, PostgreSQL and MariaDB are supported by Klaros Test Management under Docker and are ready for production.
...
|DATABASE_ROOT_PASSWORD   |P@ssw0rd          |[MySQL/MariaDB Only] Root password for the "root" user
