...
----
cd ~/klaros-docker/Microsoft\ SQL\ Server2/
vi .env
----
====
...
=== Backup über SQL wiederherstellen
...
=== Backup über Volume wiederherstellen
...
Unsere Installationsdokumentation beinhaltet die Installation von Klaros-Testmanagement unter Docker für ApacheDerby-, MariaDB-, MSSQL-, MySQL- und PostgreSQL-Datenbanken.
