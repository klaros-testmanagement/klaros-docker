...
* https://github.com/PromoFaux[Adam Warner] für die Bereitstellung des https://github.com/klaros-testmanagement/klaros-docker/pull/59[GHA-Workflow zur Veröffentlichung vorgefertigter Bilder auf ghcr.io] und  der
https://github.com/klaros-testmanagement/klaros-docker/pull/58[Anpassung der Microsoft SQL Server Version, um Remote-Instanzen zu ermöglichen]
